...
class ChatBot:
    ...
    def __generate_match_lists(self, sentence):
        ...
        if len(self.key_words_list) != 0:
            ...
            if ("uppers legs" in self.perfect_match_list and "legs" in self.perfect_match_list) or ("lower legs" in self.perfect_match_list and "legs" in self.perfect_match_list):
